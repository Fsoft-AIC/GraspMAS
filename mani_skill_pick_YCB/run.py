...
# os.chdir('/LOCAL2/anguyen/faic/quang/viper_duality')
from mani_skill_pick_YCB.pick_YCB import solvePickSingleYCB, solvePickClutterYCB
import random
...
MP_SOLUTIONS = {
    ...
    "PickSingleYCB-v1": solvePickSingleYCB,
    "PickClutterYCB-v1": solvePickClutterYCB
}
def parse_args(args=None):
    ...
    parser.add_argument("-b", "--sim-backend", type=str, default="gpu", help="Which simulation backend to use. Can be 'auto', 'cpu', 'gpu'")
    ...
    parser.add_argument("--save-traj", action="store_true", help="whether or not to save the trajectory locally")
...
def _main(args, proc_id: int = 0, start_seed: int = 0) -> str:
    ...
    env = gym.make(
        ...
        reward_mode=None if args.env_id == "PickClutterYCB-v1" else 'dense',
    ...
    if args.render_mode == "rgb_array":
        ...
        output_dir = osp.join(args.record_dir, env_id, "sensors")
    env = RecordEpisode(
        env,
    ...
    output_h5_path = env._h5_file.filename if args.save_traj else None
